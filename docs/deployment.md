...
| Binance Options Account | -- | API keys with trading permissions |
...
| Binance API Keys | Create keys with trading only (disable withdrawals) | Rotate keys every 90 days |
